...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj5030 = {};return obj5030;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3557__auto__ = this$;if(and__3557__auto__)
...
{var x__4196__auto__ = (((this$ == null))?null:this$);return (function (){var or__3569__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4196__auto__)]);if(or__3569__auto__)
{return or__3569__auto__;
} else
{var or__3569__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3569__auto____$1)
...
return (function (p__5031){var vec__5032 = p__5031;var k = cljs.core.nth.call(null,vec__5032,(0),null);var v = cljs.core.nth.call(null,vec__5032,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__5033){var vec__5034 = p__5033;var k = cljs.core.nth.call(null,vec__5034,(0),null);var v = cljs.core.nth.call(null,vec__5034,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
